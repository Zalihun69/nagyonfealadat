...
namespace ConsoleAppScreen.Models
{
    static public class Screen
    {
        ...
        {
            // TODO : (Zalán) Kitöltött téglalap rajzolásának implementációja a képernyőn
        ...
        {
            // TODO : (Zalán) Vonal rajzolásának implementációja a képernyőn
        ...
        {
            // TODO : (Zalán) Két szöveg keverésének implementációja
            // 1. példa:
            // textA = "Hello"
            // textB = "World"
            // Kimenet: HWeolrllod
            ...
            string vegeredmeny = textA + textB;
            return vegeredmeny;
        }
        

        // TODO : (Zalán) Két szöveg ismételt váltakozásának implementációja
        /// <summary>
